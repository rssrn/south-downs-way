# South Downs Way — Accommodation Options (Miles 0–37)

Winchester → Chilcomb (2.5) → Exton (12.5) → East Meon area (17) → Buriton area (25.5) → Cocking (36.5)
...
**Preferred option: Friday evening arrival, full walking day Saturday.**
...
- Five Bells Buriton (self-catering cottages) for Night 2 instead of Hampshire Hog — price unknown, must phone
- The "Chilcomb trick" (walk 2.5mi to Chilcomb on arrival day, £70) remains an option if wanting to skip Winchester entirely — see staging discussion below

**What the extra day (11 instead of 10) enables:**
- 7 walking days instead of 6 (more miles covered OR shorter daily stages)
- Keep 2 rest days in Brighton
- Buffer day for weather/fatigue

---

## Phone Call Priority List (all sections)

| Priority | Property | Question | Phone |
|----------|----------|----------|-------|
...
## Winchester (Night 0 — Fri 24 April 2026)

Friday night arrival from Bradford-on-Avon (after work). Explore Winchester Saturday morning before starting the walk.

| Property | Type | Price (double) | Breakfast | Notes |
|----------|------|----------------|-----------|-------|
| **Travelodge Winchester** | Budget chain | **£70** (Fri 24 Apr, non-refund) | Not included (~£9pp) | City centre, Market Lane SO23 9AL. **Friday pricing is good.** Saturday is £99–110 — avoid. |
| **The King Alfred** | Pub (4-star) | **from £103** | Included | Saxon Road. 5 rooms. Free parking. **Sold out Sat 25 Apr.** Friday may be available + cheaper. the.littlepubgroup.co.uk |
| **The Black Hole** | B&B | **£172** (Sat 25 Apr) / **~£89–119** other nights | Included | 10 rooms, Wharf Hill. Saturday pricing crazy. Check Friday rate. Next to Black Boy pub. ☎ 01962 807010 |
| **St John's Croft** | B&B (4-star) | **from £110** (double) | Included | Central. Free parking. st-johns-croft.co.uk |
| **Complyns, Chilcomb** | B&B | **£70** | Included | 2.5mi from Winchester. Alternative: skip Winchester hotel entirely, walk to Chilcomb on arrival. See "Chilcomb trick" below. ☎ 01962 861 600 |

**Verdict for Friday night:** Travelodge at £70 is the clear budget pick. King Alfred at £103 (with breakfast) if you want something nicer — check Friday availability.

---

## Mile 2.5 — Chilcomb (ON trail)

| Property | Type | Price (double) | Price (single) | Breakfast | Notes |
|----------|------|----------------|----------------|-----------|-------|
| **Complyns B&B** | B&B | **£70** | **£45** | Included | 17th-century farmhouse with bar and restaurant. SO21 1HT. ☎ 01962 861 600. stay@complyns.co.uk |

**The "Chilcomb trick":** Walk 2.5mi from Winchester to Chilcomb on arrival day (afternoon/evening). Saves £30+ vs Winchester hotel AND gets you 2.5mi ahead. Late April sunset ~8:15pm BST. Works for both Friday and Saturday arrival. Main downside: less time to enjoy Winchester.

---

## Mile ~4.5 → Cheriton (1.5mi OFF trail)

| Property | Type | Price (double) | Breakfast | Notes |
|----------|------|----------------|-----------|-------|
| **Brick House B&B** | B&B | **£130** | Included | 2 king en-suite. Expensive AND 1.5mi off trail with valley descent. brickhousecheriton.co.uk |

**Verdict:** Not recommended — expensive and off-trail.

---

## Mile 9 — Beauworth (ON trail)

**No accommodation.** The Milburys pub is a good lunch/drinks stop but no longer offers rooms. 10-mile gap between Chilcomb (mile 2.5) and Exton (mile 12.5).

---

## Mile 12.5 — Exton (ON trail, valley)
...
## Mile ~16.5 — East Meon (1mi OFF trail, valley)
...
## Mile ~17 — SD Eco Lodge / Sustainability Centre (ON trail)

Right ON the South Downs Way. Avoids descending into East Meon valley. **Has availability for late April 2026.**

| Option | Type | Price | Breakfast | Notes |
|--------|------|-------|-----------|-------|
| **Hostel twin** | Hostel | **£70** (£35pp) | Self-catering (kitchen + café Wed–Sun) | Linen/towels included. Book 6wk–3d ahead. |
| **Hostel triple** | Hostel | **£100** (~£33pp) | Self-catering | |
| **B&B double** (en-suite) | B&B | **from ~£70** | Included | 11 en-suite rooms. Eco-luxury. |

☎ 01730 823549 / southdownsecolodge.com

**Verdict:** Hostel twin at £70 or B&B from £70 are both good value AND on the trail. Key alternative to Exton if you want a longer Day 1 (17mi from Winchester) — solves the Butser Hill problem by making Day 2 only 8.5mi. But 17mi is ambitious for Day 1.

---

## Mile ~23.5 — Queen Elizabeth Country Park (ON trail)

**No accommodation at QE Country Park itself.** Nearest options are the Eco Lodge (5mi back) or Buriton area (2mi ahead).

---

## Mile ~25.5 — Buriton area (post-Butser Hill)

This is the weakest section for accommodation. Buriton village (0.5mi off trail) has limited options, and the village is in a valley at ~80m — lower than the trail.
...
## Mile ~28.5 — South Harting (1mi OFF trail)

| Property | Type | Price (double) | Breakfast | Notes |
|----------|------|----------------|-----------|-------|
| **The White Hart** | Pub with rooms | **~£100–180** ⚠️ | With some packages | 7 en-suite rooms. Upmarket. 15% off with BOOKDIRECT. ☎ 01730 825124 / the-whitehart.co.uk |
| **Copper Beeches** | B&B | **~£65+** ⚠️ unconfirmed | Included (farm-produced) | 2 rooms. Near S Harting, ~15min from trail. Excellent breakfast. **NB: further along trail than Buriton (~mile 28.5 area), not a Buriton substitute.** ☎ 01730 826662 |

**Note:** South Harting is 3 miles further along the trail than Buriton. These are Night 3 alternatives (Hampshire Hog → S Harting = ~5mi), not Night 2 options.

---

## Mile ~32 — Elsted Marsh (NEAR trail)

| Property | Type | Price (double) | Breakfast | Notes |
|----------|------|----------------|-----------|-------|
| **The Elsted Inn** | Pub with rooms | **~£90–120** ⚠️ | Unknown | 4 rooms in converted stables. Close to trail — avoids valley descent. ☎ 07595 933647 / elstedinn.com |

**Verdict:** Well-positioned but only makes sense if splitting the Buriton→Cocking stage (which is only 11mi — doesn't need splitting).

---

## Mile ~36.5 — Cocking (1mi OFF trail)
...
### The accommodation landscape problem
The SDW is a ridge walk but most accommodation is in valleys below. Every night in a valley costs ~100–200m extra climbing (down in the evening, back up next morning). The exceptions are:
- Chilcomb (mile 2.5) — on trail
- Crossways, Exton (mile 12.5) — valley but on trail
- SD Eco Lodge (mile ~17) — on trail, ON the ridge
- Hampshire Hog (mile ~25.5 area) — at 140m, same as trail low point

### The 25-mile accommodation desert
Between the Eco Lodge (mile ~17) and Cocking (mile ~37) there are only thin options around Buriton (mile 25.5). Butser Hill (the highest and hardest climb) sits right in this gap. This makes Night 2 staging critical.

### Alternative staging: "The Chilcomb trick"
If the Friday arrival doesn't work out, the Chilcomb trick remains viable for a Saturday arrival:
- Sat afternoon: Walk 2.5mi Winchester → Chilcomb (Complyns £70)
- Sun Day 1: Chilcomb → Eco Lodge (14.5mi, ~350–400m ascent) — £70 hostel
- Mon Day 2: Eco Lodge → Buriton/Clanfield (8.5mi over Butser Hill) — £107

This covers the same ground for £219 over 3 nights but Day 1 is 14.5mi (at the upper limit of comfort). The Friday arrival plan spreads the miles more evenly.
